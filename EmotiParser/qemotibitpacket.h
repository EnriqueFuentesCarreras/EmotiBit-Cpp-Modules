...
//______________________________________________________
    ...
    std::unordered_map<QString, EmotibitInfo> _discoveredEmotibits;	// list of EmotiBit IP addresses   //INVESTIGAR, CREO QUE CREE EL MISMO OBJETO EN EMOTIBITWIFIROBOTEA pingInterval EMOTIBITINFO
